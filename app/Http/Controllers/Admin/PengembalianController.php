...
class PengembalianController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validated['jumlah_pengembalian'] > $peminjaman->jumlah_peminjaman) {
            return back()
                ->withErrors([
                    'jumlah_pengembalian' => 'Jumlah pengembalian melebihi jumlah peminjaman',
                ])
                ->withInput();
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        $selisih = $validated['jumlah_pengembalian'] - $pengembalian->jumlah_pengembalian;
